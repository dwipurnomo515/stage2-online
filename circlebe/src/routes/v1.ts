...
routerV1.get('/threads/:threadId/reply', authentication, replyController.getReplyByPost);

routerV1.post('/threads/:threadId/reply', authentication, upload.single("image"), replyController.createReply);

routerV1.get('/threads/:threadId/like', authentication, like1Controller.getLikes);
routerV1.post('/threads/:threadId/like', authentication, like1Controller.likeThread);
